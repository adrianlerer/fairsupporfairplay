...
<p>
  <strong>Basado en el trabajo del psicólogo deportivo Marcelo Roffé</strong>
</p>
...
- 🎯 **Sistema FAQ curado** por Marcelo Roffé
- 🚦 **Alertas preventivas** para padres (sistema semáforo)
- 👥 **Comunidad moderada** de atletas jóvenes
- 📚 **Contenido educativo** sobre psicología deportiva
- 🤖 **IA para análisis** de sentimiento y bienestar
